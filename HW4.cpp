...
printf("|e.Exit system               |\n");
        mainMenu();
    return 0;}
//在撰寫這個C語言程式時，中間雖然遇到很多陣列的問題，但也學到了如何有效地處理使用者輸入並驗證數據的正確性。
//掌握了使用結構體來組織和管理複雜數據的方法，以及如何進行數據的排序和搜尋， 這個過程不僅加深了我對C語言基
//本語法和功能的理解，也使我體會到了構建實用應用程式的挑戰，這次的程式作業練習增強了我的問題解決
//能力和編程技巧，對未來的學習和開發工作有很大幫助。
